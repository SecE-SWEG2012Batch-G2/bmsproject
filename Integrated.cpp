...
int create_new_account_page()
{
	...
	customer[user].transactions[customer[user].Index].name = "Deposit";
	customer[user].transactions[customer[user].Index].date = date;
	customer[user].transactions[customer[user].Index].amount = balance;
	customer[user].Index++;
...
int withdraw_page()
{
	...
	cin >> customer[user].transactions[customer[user].Index % 6].date.day >>
		customer[user].transactions[customer[user].Index % 6].date.month >>
		customer[user].transactions[customer[user].Index % 6].date.year;
